...
mkdir -p $JENKINS_HOME/jobs/Nicoos-ubuntu1804
mkdir -p $JENKINS_HOME/jobs/Nicoos-ubuntu1804-loop
mkdir -p $JENKINS_HOME/jobs/Nicoos-ubuntu1804-valgrind
mkdir -p $JENKINS_HOME/jobs/Nicoos-freebsd12
mkdir -p $JENKINS_HOME/jobs/Nicoos-freebsd12-loop
...
mv ~vagrant/ubuntu1804.job.xml $JENKINS_HOME/jobs/Nicoos-ubuntu1804/config.xml
mv ~vagrant/ubuntu1804-loop.job.xml $JENKINS_HOME/jobs/Nicoos-ubuntu1804-loop/config.xml
mv ~vagrant/ubuntu1804-valgrind.job.xml $JENKINS_HOME/jobs/Nicoos-ubuntu1804-valgrind/config.xml
mv ~vagrant/ubuntu1804.node.xml $JENKINS_HOME/nodes/ubuntu1804/config.xml
mv ~vagrant/freebsd12.job.xml $JENKINS_HOME/jobs/Nicoos-freebsd12/config.xml
mv ~vagrant/freebsd12-loop.job.xml $JENKINS_HOME/jobs/Nicoos-freebsd12-loop/config.xml
