...
def write_header(env, filename = None):
    ...
    if not filename:
        if env['ARCH'] != 'host':
            ...
            try:
                ...
                os.symlink('.', env['BUILDROOT'] + '/include/Nicoos')
            ...
            try:
                ...
                os.symlink('.', 'build/host/include/Nicoos')
    ...
    out.write('#define BANNER "Nicoos " RELEASE " [" ARCH "/" SYSTEM "] (" BUILDUSER "@" BUILDHOST ") (" COMPILER_VERSION ") " DATETIME "\\r\\n" \n');
