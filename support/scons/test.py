...
def runTester(target, source, env):
    """
    Run the Nicoos autotester and collect XML results.
    """
    ...
    # When running from the Nicoos interactive console, first wait for
...
#
# Run the Nicoos autotester inside qemu
#
...
#
# Run the Nicoos autotester inside qemu, with many iterations
#
...
#
# Run Nicoos autotester in a host OS local process
#
